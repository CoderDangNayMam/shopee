...
import com.vti.shoppee.config.JWTRequestFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("api/not-authenticated", "/api/v1/account/*", "/api/v1/auth/login-basic-v2"
                        , "/api/v1/auth/login-jwt","/api/v1/product/search").permitAll()
        ...
        // khai báo lớp filter sẽ được thực hiện trước khi authen và author (xác thực và phân quyền)
